 ...
 */
namespace Kento\CustomShipmentPdf\Model\Order\Pdf;
...
class Shipment extends AbstractPdf
{
    ...
    protected function _drawHeader(\Zend_Pdf_Page $page)
    {
        ...
        $lines[0][] = ['text' => __('Location'), 'feed' => 395];

        
        $lines[0][] = ['text' => __('Pulled'), 'feed' => 70];
    ...
    public function getPdf($shipments = [])
    {
        ...
        foreach ($shipments as $shipment) {
            ...
            /* Add body */
            /*starts here*/
            //get the location value here (need item id and repackage  into array that loop through in the foreach)
            foreach ($shipment->getAllItems() as $item) {
               ...
               // var_dump($item);
                ...
                //$item = array('1'=>$item->getName(),'2'=>$item->getPrice());
                $this->_drawItem($item, $page, $order);
               //var_dump($item);
               ...
               /*
               echo '<br/>qty:'. $item->getQty().'<br/>';
               echo 'name: '.$item->getName().'<br/>';
               echo 'price: '.$item->getPrice().'<br/>';
               echo 'name: '.$product->getName().'<br/>';
               echo 'location: '.$product->getLocation().'<br/>';
               echo 'location: '.$product->getAttributeText('location').'<br/>';
               echo 'product id: '.$item->getProductId().'<br/>';
               echo 'sku: '.$item->getSku().'<br/>';
               echo 'id: '.$item->getId().'<br/><br/>';
              */
                $page = end($pdf->pages);
            }
            //die;
